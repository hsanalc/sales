...
const NAV = [
  ...
  { to: "/dashboard", label: "Client Dashboard", icon: Users },
] as const;
  ...
  return (
    <header className="sticky top-0 z-40 w-full border-b border-navy/20 bg-navy text-white shadow-elevated">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-white/10 ring-1 ring-white/20 backdrop-blur transition-transform group-hover:scale-105">
            ...
            NAV.map((n) => {
              ...
              return (
                ...
                >
                  ...
                  <span>{n.label}</span>
                  {active && <span className="absolute -bottom-1 left-3 right-3 h-0.5 rounded-full bg-orange" />}
                </Link>
              );
            })}
          <Button
        ...
        <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
          ...
          <SheetContent side="right" className="w-72 border-navy/30 bg-navy text-white">
